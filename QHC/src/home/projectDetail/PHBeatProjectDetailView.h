...
@interface PHBeatProjectDetailView : UIView<UITableViewDataSource, UITableViewDelegate, LoginDelegate, QHCSelectedStoreDelegate, QHCSelectedMasterDelegate, BespeakTimeSelectViewDelegate>{
    NSString *projectId;
