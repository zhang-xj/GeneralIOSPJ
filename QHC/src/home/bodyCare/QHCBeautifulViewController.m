...
@interface QHCBeautifulViewController ()

@end

@implementation QHCBeautifulViewController
...
- (void)viewDidLoad {
    ...
    QHCBeautifulView *beautifulView = [[QHCBeautifulView alloc] initWithFrame:CGRectMake(0.0, titleView.frame.size.height, self.view.frame.size.width, self.view.frame.size.height - titleView.frame.size.height)];
    [self.view addSubview:beautifulView];
}
